...
public struct AdaptiveGrid: View {
    ...
    public init(horizontalSpacing: CGFloat? = nil, verticalSpacing: CGFloat? = nil, showDivider: Bool = false, content: GridContainer) {
    ...
    public init(horizontalSpacing: CGFloat? = nil, verticalSpacing: CGFloat? = nil, showDivider: Bool = false, @GridBuilder content: () -> GridContainer) {
        self.rows = content().rows
        self.horizontalSpacing = horizontalSpacing
        self.verticalSpacing = verticalSpacing
        self.showDivider = showDivider
